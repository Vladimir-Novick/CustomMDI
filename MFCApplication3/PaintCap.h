...
//
//	BOOL Install(CDialog* pWnd, UINT nPaintMsg = 0, BOOL bMod = FALSE);
...
/////////////////////////////////////////////////
//
////// To use it in a dialog:
//////
////// put these in your dialog header
////LRESULT OnPaintMyCaption(WPARAM wp, LPARAM lp);
////CCaptionPainter m_capp;
//////
////// In your .cpp file, add this to your message map
////ON_MESSAGE(WM_PAINTMYCAPTION, OnPaintMyCaption)
//////
////// In your OnInit Dialog, add this:
////m_capp.Install(this, WM_PAINTMYCAPTION);
////// Also in your .cpp file, add this
////LRESULT[your dialog class name here]::OnPaintMyCaption(WPARAM bActive, LPARAM lParam)
////{
////	CString winText;
////	GetWindowText(winText);
////	m_capp.PaintMyCaption(bActive, lParam, winText);
////	return 0;
////}
